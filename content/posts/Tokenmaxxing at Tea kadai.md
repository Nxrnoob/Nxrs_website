...
- now make a shortcut of the abouve flow so you dont type your tailscale ip again and again, paste this in your termux ````mkdir -p ~/.ssh cat > ~/.ssh/config <<EOF Host pc     HostName 100.x.y.z User your-username EOF chmod 600 ~/.ssh/config```` edit those lines with your username and ip address
